...
set CLASSPATH=%APP_HOME%\lib\lab1.jar;%APP_HOME%\lib\kotlin-stdlib-1.9.24.jar;%APP_HOME%\lib\annotations-13.0.jar


@rem Execute lab1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB1_OPTS%  -classpath "%CLASSPATH%" MainKt %*
